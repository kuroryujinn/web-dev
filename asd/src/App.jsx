...
const AppShell = () => {
  ...
  return (
    ...
    >
      <main className="relative w-full min-h-screen z-10 transition-all duration-500 max-w-[1440px] mx-auto">
        <AppContent />
      </main>
      ...
      <div
        aria-hidden="true"
        className="fixed inset-0 pointer-events-none overflow-hidden h-screen w-screen z-0"
      >
